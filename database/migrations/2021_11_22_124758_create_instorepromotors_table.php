...
class CreateInstorepromotorsTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('instorepromotors', function (Blueprint $table) {
            $table->bigIncrements('id_isp');
            $table->date('tanggal');
        ...
        Schema::table('instorepromotors', function (Blueprint $table) {
    ...
    {
        Schema::dropIfExists('instorepromotors');
    }
}

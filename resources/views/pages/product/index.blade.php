...
@section('title','Jenis Produk Yang Diajarkan')
...
<div class="container-fluid">
    ...
    <div class="d-sm-flex align-items-center mb-3 mt-4">
        <h1 class="h3 text-dark">Jenis Produk Yang Diajarkan</h1>
    </div>
        ...
        <div class="col-md">
            <div class="card">
                <div class="card-header py-3">
                    <a href="{{route('tambahproduct')}}" class="btn btn-primary btn-icon-split btn-sm mb-1">
                        ...
                        <table class="table table-bordered table-hover table-sm text-dark nowrap" width="100%" cellspacing="0" id="projecttable">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <!-- Button Edit Data -->
                                        <a href="/product/{{$product->id_product}}/edit" class="btn btn-secondary btn-sm">
                                            <i class="fa fa-pencil-alt"></i>
                                        </a>
                                        <!-- Link Hapus Data -->
                                        <a href="/product/{{$product->id_product}}/hapus" class="btn btn-danger btn-sm btn-flat delete-confirm">

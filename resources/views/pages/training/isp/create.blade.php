...
@section('title','Tambah In Store Promotor')
@section ('content')
    <!-- Begin Page Content -->
<div class="container-fluid">

    <div class="d-sm-flex align-items-center mb-3 mt-4">
        <h1 class="h3 text-dark">Tambah In Store Promotor</h1>
    </div>
    ...
    <div class="row mb-5">
        <div class="col-sm text-dark">
            <div class="card">
                <div class="card-body">
                    <form action="{{route('tambahdataisp')}}" method="POST" enctype="multipart/form-data">
                    @csrf
                    ...
                    <div class="form-group row">
                        <label for="gambar"  class="col-sm-3 col-form-label">Tambah Gambar (Maximal 5 MB)</label>
                        <div class="col-sm-9">
                            <input name="gambar" accept=".jpg" type="file" id="gambar" required class="form-control-file @error('gambar') is-invalid @enderror">
                            @error('gambar')
                            <div class="invalid-feedback"> {{ $message }}</div>
                            @enderror
                        </div>
